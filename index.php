    ...
    <main>
        ...
        <div class="start-hide hidden">
            <h1 class="opening-line side-padding">
                Tworzymy
                <a href="./pricing.php"><span data-content="strony">strony</span></a>
                i
                <a href="./pricing.php"><span data-content="sklepy">sklepy</span></a>
                internetowe
                <br>z myślą o
            ...
            <section class="order">
                <a href="pricing.php" class="button">
            ...
            <footer>
                <h4 class="links">
                    <!-- <a href="./portfolio.php">portfolio</a> -->
                    <a href="pricing.php"><span data-content="cennik">cennik</span></a>
                    <a href="about-us.php"><span data-content="o nas">o nas</span></a>
                </h4>
                <h4 class="contact">
                    <a href="mailto:hello@http.family">
                        <span data-content="hello@http.family">hello@http.family</span>
                    </a>
                </h4>
            </footer>
        </div>
